...
Public Class FirstTimeLogin2
    ...
    Public Sub setEmpId(ByVal empId As String)
        Me.empId = empId
        Me.getProfile()
    End Sub
    ...
    Private Sub btn_edit_profile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_sign_up_profile.Click
        Dim provider As String
        Dim dataFile As String
        Dim connString As String
        Dim myConnection As OleDbConnection = New OleDbConnection
        ...
        myConnection.Close()
        MsgBox("User Profile has been successfully updated.")
        Me.Hide()
        landing_page.emp_id.Text = employeeId.ToString
        landing_page.Show()

    End Sub

    Private Sub OnFormShown(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Shown
        Me.getProfile()
    End Sub
End Class